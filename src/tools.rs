...
pub fn check_mandatory_items(message: &Cat34Message) -> Cat34Error {
    match message.message_type
    {
        ...
        MessageType::JammingStrobe => return check_north_marker_items(message),
        MessageType::SolarStorm => return check_north_marker_items(message),
        MessageType::SSRJammingStrobe => return check_north_marker_items(message),
        MessageType::ModeSJammingStrobe => return check_north_marker_items(message),
    };
}
